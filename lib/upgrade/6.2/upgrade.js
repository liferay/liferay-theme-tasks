...
module.exports = function(options) {
	...
	gulp.task('upgrade:vm-templates', function() {
		var vmRules = [
			{
				message: 'Warning: Velocity (.vm) is deprecated, consider migrating to Freemarker (.ftl) format. Check out https://dev.liferay.com/de/develop/tutorials/-/knowledge_base/7-0/upgrading-themes#updating-theme-templates details.'
			},
			{
